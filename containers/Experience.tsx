...
export default function Experience() {
  return <div className='w-full pb-10 text-tb'>
    ...
    <p className='text-[20px] font-bold'>VOOKS</p>
    ...
    <div className='flex items-end w-full flex-col mb-2 max-[590px]:items-start'>
      <p className='text-[20px] font-bold mt-8'>J. BLANTON PLUMBING</p>
    ...
    <p className='text-[20px] font-bold mt-8'>ALLWORLD SEO</p>
    <p className='mb-2'>March 2019 - April 2022</p>
    ...
    <div className='flex max-[590px]:flex-col'>
      ...
      <p className='flex-1 ml-4 text-justify mt-[-5px] max-[590px]:ml-0 max-[590px]:mt-4'>My career started here at ALLWorld. I was the only developer here. Here in ALLWorld, I talk directly to all the clients that we handle. We discuss the features and designs for the application.</p>
    </div>
  </div>
}
